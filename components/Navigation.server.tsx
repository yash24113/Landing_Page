      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-8">
            ...
            <a href="#contact" className="text-slate-700 hover:text-slate-900 font-medium transition-colors">Contact USD</a>
            ...
            <details className="relative">
              ...
              <div className="absolute right-0 mt-2 w-[88vw] max-w-sm rounded-2xl border border-slate-200 bg-white shadow-lg p-4">
                <ul className="flex flex-col gap-2">
                  ...
                  <li><a className="px-3 py-3 rounded-lg hover:bg-slate-50" href="#contact">Contact US</a></li>
                </ul>
