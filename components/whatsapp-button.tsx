    ...
    <>
      ...
      >
        ...
        <button
          ...
          // smaller on phones, bigger on md+
        ...
        >
          ...
          {/* notification dot (reduced motion: pause animations) */}
          <div className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-red-500 rounded-full motion-safe:animate-ping" aria-hidden="true" />
          <div className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-red-500 rounded-full" aria-hidden="true" />
        </button>
      </div>
